...
agentcrdt ships an MCP server that exposes its core operations as native Claude tools.
...
agentcrdt is listed on [smithery.ai](https://smithery.ai) — search for "agentcrdt" to install with one click.
